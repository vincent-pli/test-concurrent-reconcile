...
import (
	...
	internalinterfaces "github.com/vincentpli/concurrent-reconcile/pkg/client/informers/externalversions/internalinterfaces"
	v1alpha1 "github.com/vincentpli/concurrent-reconcile/pkg/client/listers/job/v1alpha1"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.CustomV1alpha1().Jobs(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.CustomV1alpha1().Jobs(namespace).Watch(context.TODO(), options)
			},
		},
		&jobv1alpha1.Job{},
		resyncPeriod,
...
func (f *jobInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&jobv1alpha1.Job{}, f.defaultInformer)
}
