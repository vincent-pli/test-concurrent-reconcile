...
import (
	...
	externalversions "github.com/vincentpli/exception-handler/pkg/client/informers/externalversions"
...
func Get(ctx context.Context) externalversions.SharedInformerFactory {
	...
	if untyped == nil {
		logging.FromContext(ctx).Panic(
			"Unable to fetch github.com/vincentpli/exception-handler/pkg/client/informers/externalversions.SharedInformerFactory from context.")
	}
